...
const EditPost = () => {
    ...
    useEffect(() => {
        ...
        const fetchPost = async () => {
            try {
                ...
                const description =
                    raw.post_description || raw.description || "";
                ...
                // 3) รูปปก
                const coverRaw =
                    raw.cover_url || raw.cover || raw.coverPath || "";
                ...
                const fileNameDirect =
                    raw.file_name || raw.document_original_name || "";
    ...
    const handleSubmit = async (e) => {
        ...
        // 🔒 Validation กันลบจนว่าง
        if (!postData.title.trim()) {
            setError("กรุณากรอกหัวข้อสรุป");
            return;
        }
        if (!postData.description.trim()) {
            setError("กรุณากรอกคำอธิบายสรุป");
            return;
        }
        ...
        try {
            ...
            }, 800); // จะเพิ่มหรือลดเวลาได้ตามชอบ เช่น 1000ms
        } catch (e) {
            setSuccessMsg("");
                            ...
                            <form onSubmit={handleSubmit} className="edit-form-col">
                                ...
                                <div className="edit-field">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="อธิบายสั้น ๆ ว่าโพสต์นี้เกี่ยวกับอะไร"
                                    />
                                </div>
                                ...
                                {/* ✅ Success message (เขียว) – fixed height กันการ์ดเด้ง */}
                                {/* Message (เขียว / แดง ใช้ที่เดียวกัน) */}
